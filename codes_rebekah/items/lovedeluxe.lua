...
yandereWaifu:AddCallback(ModCallbacks.MC_POST_PEFFECT_UPDATE, function(_,player)
	...
	if player:HasCollectible(RebekahCurse.Items.COLLECTIBLE_LOVEDELUXE) then
...
yandereWaifu:AddCallback(ModCallbacks.MC_POST_RENDER, function(_, _)
	...
	for p = 0, InutilLib.game:GetNumPlayers() - 1 do
		...
		if player:HasCollectible(RebekahCurse.Items.COLLECTIBLE_LOVEDELUXE) and Options.ChargeBars then
