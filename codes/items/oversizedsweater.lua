yandereWaifu:AddCallback(ModCallbacks.MC_PRE_PICKUP_COLLISION, function(_, pickup, coll, low)
	...
	if player and player:HasCollectible(RebekahCurse.COLLECTIBLE_OVERSIZEDSWEATER) then
...
yandereWaifu:AddCallback(ModCallbacks.MC_POST_PEFFECT_UPDATE, function(_,player)
	...
	--items function!
	if player:HasCollectible(RebekahCurse.COLLECTIBLE_OVERSIZEDSWEATER) and InutilLib.HasJustPickedCollectible( player, RebekahCurse.COLLECTIBLE_OVERSIZEDSWEATER ) then
