...
local seedtbl = {
		[0] = {seed = SeedEffect.SEED_KAPPA, name = "Kappa", subname = "Kappa"},
		[1] = {seed = SeedEffect.SEED_CAMO_ISAAC, name = "Isaac is now hidden!", subname = "You can't see me"},
		[2] = {seed = SeedEffect.SEED_CAMO_ENEMIES, name = "Foes are now hidden!", subname = "Rise above hate!"},
		[3] = {seed = SeedEffect.SEED_CAMO_PICKUPS, name = "Loot is now hidden!", subname = "If you don't learn from your mistakes, then they become regrets"},
		[4] = {seed = SeedEffect.SEED_DYSLEXIA, name = "Dyslexia", subname = "a 0  jA hb a"},
		[5] = {seed = SeedEffect.SEED_OLD_TV, name = "Dogma's Vision", subname = "Who's Steve?"},
		[6] = {seed = SeedEffect.SEED_EXTRA_BLOOD, name = "More Gore!", subname = "Rip your enemies!"},
		[7] = {seed = SeedEffect.SEED_BIG_HEAD, name = "Megahead!", subname = "A severe lack of female companions?"},
		[8] = {seed = SeedEffect.SEED_SMALL_HEAD, name = "Tinyhead", subname = "One brain cell left"},
		[9] = {seed = SeedEffect.SEED_BLACK_ISAAC, name = "Sillouhette", subname = "Who's that Isaac?"},
		[10] = {seed = SeedEffect.SEED_SLOW_MUSIC, name = "Relax!", subname = "Listen and chill"},
		[11] = {seed = SeedEffect.SEED_ULTRA_SLOW_MUSIC, name = "Relax...", subname = "beats to relax/study to"},
		[12] = {seed = SeedEffect.SEED_FAST_MUSIC, name = "Rock on!", subname = "Gotta go fast!"},
		[13] = {seed = SeedEffect.SEED_ULTRA_FAST_MUSIC, name = "ROCK ON!!!", subname = "Now listen with 2x"},
		[14] = {seed = SeedEffect.SEED_ICE_PHYSICS, name = "Slippery slope", subname = "Careful"},
		[15] = {seed = SeedEffect.SEED_CHRISTMAS, name = "Christmas!", subname = "On an Easter Egg?"},
		[16] = {seed = SeedEffect.SEED_RETRO_VISION, name = "Retro Vision!", subname = "Again??"},
		[17] = {seed = SeedEffect.SEED_PICKUPS_TIMEOUT, name = "Loot rots!", subname = "Matthew 6:19"},
		[18] = {seed = SeedEffect.SEED_SHOOT_IN_MOVEMENT_DIRECTION, name = "Bravery!", subname = "Fight fearless!"},
		[19] = {seed = SeedEffect.SEED_SHOOT_OPPOSITE_MOVEMENT_DIRECTION, name = "Cowardice...", subname = "Fight in fear"},
	}
...
local cursetbl = {
		[1] = {curse = LevelCurse.CURSE_OF_DARKNESS, name = "Permanent Darkness"},
		[2] = {curse = LevelCurse.CURSE_OF_LABYRINTH, name = "Inescapable Labyrinth"},
		[3] = {curse = LevelCurse.CURSE_OF_THE_LOST, name = "Hopelessly Lost"},
		[4] = {curse = LevelCurse.CURSE_OF_THE_UNKNOWN, name = "Forever Unknown"},
		[5] = {curse = LevelCurse.CURSE_OF_MAZE, name = "Unending Maze"},
		[6] = {curse = LevelCurse.CURSE_OF_BLIND, name = "Incurable Blindness"},
		[7] = {curse = LevelCurse.CURSE_OF_THE_CURSED, name = "Horrible Curse"},
	}
